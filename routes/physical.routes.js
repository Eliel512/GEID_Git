...
const physicalSearchCtrl = require('../controllers/archives/physical/search');

// ─── Recherche unifiée (tous niveaux + archives) — AVANT les routes paramétrées
router.get('/search', physicalSearchCtrl.search);
router.get('/path/:level/:id', physicalSearchCtrl.getPath);
