/**
 * serverStore.js — Store en mémoire des connexions socket (process local)
 *
 * Stocke l'instance Socket.io et la map des utilisateurs connectés
 * pour le process courant uniquement (non distribué entre workers).
 *
...
/** Map socketId → { userId, socket } pour ce worker uniquement */
...
module.exports = {
  ...
  /**
   * Ajoute un utilisateur connecté dans la map locale.
  ...
  /**
   * Supprime un utilisateur déconnecté de la map locale.
